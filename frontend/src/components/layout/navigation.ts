 ...
 *
 * Only /dashboard and /dev/health exist today; the rest are placeholders for
 * the phases that build them, and are marked as such in the UI.
 */
...
export const IMPLEMENTED_ROUTES = new Set(['/dashboard', '/dev/health'])
